...
private:
    ...
    void                   ** buf;
    unsigned long in_count;// mehdi for queue rate
    unsigned long out_count;// mehdi for queue rate
...
public:
    ...
    SWSR_Ptr_Buffer(unsigned long n, const bool=true):
        pread(0),pwrite(0),size(n),buf(0),/*mehdi*/in_count(0),out_count(0)/*Mehdi*/ {
    }
   ...
   inline unsigned long get_input_number(){ return in_count;} /*Mehdi*/
   inline unsigned long get_output_number(){ return out_count;} /*Mehdi*/
    /** 
