...
#ifndef _FF_OCL_REC_HPP_
#define _FF_OCL_REC_HPP_
#ifdef __APPLE__
...
struct oclParameter{
oclParameter(cl_device_id did):d_id(did){}
cl_context context;
cl_program program;
...
class ff_oclParam{
public:
    virtual oclParameter*  set_oclParameter(cl_device_id dId)=0;
};
