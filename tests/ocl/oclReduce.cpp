...
// using macro and not object oriented base classes can cause a serious problem in running VIP stuff. because user is responsible for 
// destrucor and constructor i.e. DELETEREDUCE
