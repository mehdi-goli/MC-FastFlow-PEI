...
// c++ does not call destructor for pointer automatically.
//the order in calling different classes destructor is undetermined.
// considering two above fact we need macro for the first one and putting finaliser in the destructor of the ff_manager
// for the second one we need to put call the callback function in the destructor of all fastflow components